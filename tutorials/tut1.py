...
## scikit-learn solver option, either BRR or ARD, make sure to set fit_intercept=False, compute_score=True, normalize=True in either (default is BRR)
solver = BayesianRidge(fit_intercept=False, compute_score=True, normalize=True)
#solver = ARDRegression(fit_intercept=False, compute_score=True, normalize=True)
